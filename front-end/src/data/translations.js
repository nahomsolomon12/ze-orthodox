export const translations = {
  en: {
    ...
    heroSlideOne: "Discover the Ancient Faith",
    heroSlideTwo: "Grow Through Timeless Teaching",
    heroSubtitle:
    ...
    libraryTitle: "Learn at your own pace",
    libraryIntro:
      "Start with a lesson, return to the library, and keep building a deeper understanding of the faith.",
    featuredLessonLabel: "Featured lesson",
    featuredLessonMeta: "Video and audio library",
    featuredLessonTitle: "Teaching for everyday faith",
  ...
  am: {
    ...
    watchOnYoutube: "በYouTube ይመልከቱ",
    languageEnglish: "እንግሊዝኛ",
    languageBoth: "እንግሊዝኛ እና አማርኛ",
    lessonComingSoon: "የዚህ ክፍል ትምህርቶች በቅርቡ እዚህ ይቀርባሉ።",
    chooseLessonTrack: "ለመጀመር የትምህርት ዘርፍ ይምረጡ።",
    heroBadge: "የኢትዮጵያ ኦርቶዶክስ ክርስቲያናዊ ትምህርት",
    heroTitleTop: "በጥንታዊው",
    heroTitleAccent: "እምነት እደጉ",
    heroSlideOne: "ጥንታዊውን እምነት ያግኙ",
    heroSlideTwo: "በዘላቂ ትምህርት ይደጉ",
    heroSubtitle:
      "የኢትዮጵያ ኦርቶዶክስን ሀብታም ትውፊት በቪዲዮ፣ በድምጽ ትምህርቶች እና ሊወርዱ በሚችሉ የጥናት መርጃዎች ያስሱ።",
    beginLearning: "መማር ጀምር",
    learnMore: "ተጨማሪ ይወቁ",
    howLearn: "እንዴት ይማራሉ",
    libraryTitle: "በራስዎ ፍጥነት ይማሩ",
    libraryIntro: "በትምህርት ይጀምሩ፣ ወደ መማሪያ ማውጫው ይመለሱ፣ እና ስለ እምነትዎ ጥልቅ ግንዛቤ ይገንቡ።",
    featuredLessonLabel: "የተመረጠ ትምህርት",
    featuredLessonMeta: "የቪዲዮ እና የድምጽ መማሪያ ማውጫ",
    featuredLessonTitle: "ለዕለታዊ እምነት ትምህርት",
    exploreVideos: "ቪዲዮዎችን ያስሱ",
    studyMaterialsLabel: "የጥናት መርጃዎች",
    viewLessons: "ትምህርቶችን ይመልከቱ",
    featureVideoTitle: "የቪዲዮ እና የድምጽ ትምህርቶች",
    featureVideoDesc:
      "ከኦርቶዶክስ ምሁራን እና ካህናት የቀረቡ የቪዲዮ እና የድምጽ ትምህርቶችን በማንኛውም ጊዜ ይመልከቱ ወይም ያዳምጡ።",
    featureReadingTitle: "ሊወርዱ በሚችሉ የPDF ፋይሎች",
    featureReadingDesc: "የትምህርት ማስታወሻዎችን እና ንባቦችን እንደ PDF ያውርዱ።",
    ...
    valueTraditionDesc: "ሁሉም ይዘት ከኦርቶዶክስ ቤተ ክርስቲያን ትምህርት ጋር ይስማማል።",
    valueAcademicTitle: "በምሁራዊ መሠረት",
    valueAcademicDesc: "ጥልቀትና ግልጽነት በሚያመጡ ምሁራን የተዘጋጀ።",
    valueAccessTitle: "ለሁሉም ተደራሽ",
    valueAccessDesc: "ለመማር ለሚፈልግ ሁሉ ነፃ መርጃዎች።",
    contactTitle: "ያግኙን",
    contactIntro: "ጥያቄ ወይም ሀሳብ አለዎት? ከእርስዎ መስማት ደስ ይለናል።",
    contactSuccess: "እናመሰግናለን! መልእክትዎ ተልኳል።",
    contactName: "ስም",
    contactEmail: "ኢሜይል",
